<%@ Page Language="C#" AutoEventWireup="true" CodeFile="about2.aspx.cs" Inherits="english_about2" %>

<%@ Register src="../com/en/enAbout.ascx" tagname="enAbout" tagprefix="uc1" %>
...
<%@ Register src="../com/foot.ascx" tagname="foot" tagprefix="uc5" %>
    ...
    <td width="220" bgcolor="#EEF2FA"><table width="98%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" id="line">
      <tr>
        <td width="100%" valign="top">
            <uc1:enAbout ID="enAbout1" runat="server" />
        </td>
      </tr>
    </table>
    ...
    <td width="760"><table width="100%" height="500" border="0" cellpadding="0" cellspacing="0" id="Table1">
      <tr>
        <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" style="background:#DEE7F9">
          <tr>
            <td><div id="lat">当前位置：Homepage &gt;<asp:Label ID="Label1" runat="server"></asp:Label>
                                                </div></td>
          </tr>
        </table>
...
</table> <uc5:foot ID="foot1" runat="server" />
    </div>
